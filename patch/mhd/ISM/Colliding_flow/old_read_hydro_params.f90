subroutine read_hydro_params(nml_ok)
  ...
  namelist/hydro_params/gamma,courant_factor,smallr,smallc &
       ...
       & ,pressure_fix,nordlund_fix,scheme,riemann,riemann2d,switch_solv
  ...
  namelist/physics_params/cooling,haardt_madau,metal,isothermal &
       & ,bx_bound,by_bound,bz_bound,turb,dens0,V0,del_star &
       & ,eta_sn,yield,rbubble,t_delay,z_ave,f_ek &
       & ,J21,a_spec,eta_mag,temper_iso
