subroutine read_hydro_params(nml_ok)
  ...
  namelist/init_params/filetype,initfile,multiple,nregion,region_type &
       ...
       & ,A_region,B_region,C_region,mass_c,rap,cont,ff_sct,ff_rt,ff_act,ff_vct,thet_mag &
       & ,bl_fac
  ...
  namelist/physics_params/cooling,haardt_madau,metal,isothermal,bondi &
       ...
       & ,sn_list, sn_freq_mult, supernovae ! supernova list file
...
104 if(nboundary>MAXBOUND)then
  ...
  if(supernovae) then
    ...
    ! Conversion factor from user units to cgs units
      ...
      sn_mass_ref = 2.d34 / (scale_d * scale_l**3) !10 solar mass ejected
    else
